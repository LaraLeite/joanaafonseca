  ...
  return (
    <main className="flex flex-col w-full items-center min-h-screen bg-bg-lara">
      ...
      <section className="w-full max-w-4xl mx-auto px-6 py-12 md:py-20 text-center flex flex-col gap-6">
        <h1 className="[font-family:'Old_Standard_TT',Helvetica] italic text-textotitle text-3xl md:text-3xl tracking-tight">
          Especialidades
        </h1>
          ...
          {specialtyItems.map((item, index) => (
            <div key={index} className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-4">
                <h2 className="[font-family:'Old_Standard_TT',Helvetica] italic text-textotitle text-2xl md:text-[22px] leading-[1.2] leading-tight">
                  {item.title}
                </h2>
