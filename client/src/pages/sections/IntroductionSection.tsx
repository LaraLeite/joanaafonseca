        ...
        <div className="relative max-w-[1200px] mx-auto px-8 grid grid-cols-1 md:grid-cols-2 items-center gap-12 min-h-[500px] md:min-h-[730px] py-16 md:py-0">
          <FadeUp className="flex flex-col items-center md:items-start text-center md:text-left gap-6">
            ...
            <p className="texto-lg [font-family:'Literata',Helvetica] font-normal text-white/85">
              ...
              um espaço seguro onde cada pessoa se possa sentir verdadeiramente compreendida.<span class="break-normal"> Acredito numa abordagem integrativa e personalizada, que respeita a singularidade de cada história e de 
              cada percurso.</span> <span class="break-normal"> Com presença, empatia e cuidado, procuro apoiar cada pessoa a encontrar o seu próprio caminho de crescimento, equilíbrio e bem-estar.</span>
            </p>
          </FadeUp>
