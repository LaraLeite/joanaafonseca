    ...
    <section className="w-full px-6 py-16 md:py-20">
      <div className="max-w-[1200px] mx-auto">
        <FadeUp className="text-center mb-12">
          <h2 className="[font-family:'Old_Standard_TT',Helvetica] font-normal italic text-[#893420] text-3xl tracking-tight leading-tight mb-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {interventionAreas.map((area, index) => (
            <FadeUp key={index} delay={(index % 3) * 0.1} className="flex flex-col gap-3">
              ...
              <h3 className="[font-family:'Old_Standard_TT',Helvetica] font-normal italic text-[#893420] text-2xl md:text-[22px] leading-[1.25]">
                {area.title}
              </h3>
              ...
              <Link
                ...
                className="btn-pill inline-block w-fit px-4 py-1 rounded-[50px] border border-[#C79DCE] [font-family:'Literata',Helvetica] font-medium text-sm text-[#893420] text-base hover:bg-[#B84C32] hover:text-white hover:border-[#B84C32] transition-all duration-200"
              >
                Saiba mais
              </Link>
            </FadeUp>
